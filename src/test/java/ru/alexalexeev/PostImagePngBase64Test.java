...
public class PostImagePngBase64Test extends BaseTest{
    String encodedImage;
    ...
    @Test
    @DisplayName("Post image .png in code base64")
    void uploadFileTest() {
    ...
    private byte[] getFileContentInBase64() {
        ...
        File inputFile = new File(Objects.requireNonNull(classLoader.getResource("./zlo.png")).getFile());
