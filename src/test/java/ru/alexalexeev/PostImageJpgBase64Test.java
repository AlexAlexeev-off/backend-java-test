...
public class PostImageJpgBase64Test extends BaseTest{
    String encodedImage;
    ...
    @Test
    @DisplayName("Post image .jpg in code base64")
    void uploadFileTest() {
    ...
    private byte[] getFileContentInBase64() {
        ...
        File inputFile = new File(Objects.requireNonNull(classLoader.getResource("./zlo.jpg")).getFile());
